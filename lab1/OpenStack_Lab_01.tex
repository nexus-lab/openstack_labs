...
% Section 1
%%%%%%%%%%%
\section{Launching an Instance with the Horizon Dashboard}
...
\begin{enumerate}
    ...
    \item Scroll down (if needed) and click the $\uparrow$ icon beside the \textbf{m1.small} flavor.
    Click \textbf{Next}.
...
\begin{enumerate}
    ...
    \item Create a new instance with the name \textbf{prod-instance}, using \textbf{ubuntu} as the image, \textbf{m1.small} as the flavor, and \textbf{shared} as the network.
    \begin{lstlisting}
