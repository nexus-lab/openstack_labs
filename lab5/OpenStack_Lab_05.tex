...
\begin{enumerate}
    ...
    \item Use the \textbf{chmod} command with a mode of \textbf{600} to make it so that the \textbf{ubuntu}
    ...
    \begin{notebox}
        You can verify with the command \textbf{openstack security group rule show RULE\_ID} that the default rules
