...
In this task, you will create and delete flavors using the \textit{Horizon Dashboard} and \textit{OpenStack Unified CLI}.
...
You will also pause and stop an instance using the \textit{OpenStack Unified CLI}.
