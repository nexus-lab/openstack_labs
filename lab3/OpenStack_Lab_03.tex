...
% Section 1
%%%%%%%%%%%
\section{Uploading Images}\label{sec:uploading_images}
...
\begin{enumerate}
    ...
    \begin{labstep}
        In the format dropdown, select \textbf{QCOW2 - QEMU Emulator}, and under \textit{Image Sharing}, set \textit{Visibility} to \textbf{Private}. % chktex 8
