...
{
    \fancyhf{}
    \fancyhead[L]{\footnotesize Lab 12: Deploying an FTP Server}
...
\end{lstlisting}
    ...
    \texttt{OS\_USERNAME} to \textbf{superuser}, and change the \texttt{OS\_TENANT\_NAME} to \textbf{prod}. The file
...
% TODO(lucas): This is still broken. My feeling is that maybe the 172 interface on workstation should be the gateway and
% DNS nameserver. I tried these changes and they did not work. I also played around with ip route with no success.
...
% TODO(lucas): Is nano available? If not, use vi, vim, or anything that is installed.
...
% TODO(lucas): Test this with "ftp:" first.
% TODO(lucas): Run "ls -al" on this directory after and explain what this command does.
