...
\begin{enumerate}
    ...
    \item Now, we will replicate the previous router from the CLI.
...
\begin{enumerate}
    ...
    \item Use the \textbf{scp} command to send the \textbf{keypair2} key pair to the \textbf{devstack} machine over SSH.
