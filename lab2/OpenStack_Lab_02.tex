...
\begin{enumerate}
    ...
    \begin{center}
        \includegraphics[scale=0.75]{images/part1/step6.png}
    \end{center}
...
\begin{enumerate}
    ...
    \textbf{cloud-test2} user. Navigate to \textbf{Identity $>$ Users}. Click on the drop down in the \textit{Actions}
...
\begin{enumerate}
    ...
    \item Next, the admin role for \textbf{cloud-user2} will be used to perform an admin action. In partciular, the
    admin privileges of \textbf{cloud-user2} will be used to delete another user. First, follow steps
    ...
    \begin{lstlisting}
        ubuntu@workstation:~$ source ~/keystonerc-cloud-dev
        ubuntu@workstation:~$ openstack user list
    \end{lstlisting}
